...
const Footer = () => {
    return (
        <div className=''>
            <footer className="flex flex-col justify-center items-center text-center bg-gray-200 container mx-auto mt-40 mb-5 rounded-xl py-20 border border-white/70 space-y-2">
